...
CTA = (
    "접수 방법을 선택하세요:\n"
    "1. AI 접수: 이름, 연락처, 이사 날짜, 출발지/도착지를 알려주시면 바로 접수해 드립니다.\n"
    "2. 직접 접수: 다이사(https://da24.co.kr)에서 여러 업체 견적을 한 번에 비교하고 신청하세요."
)
...
ESTIMATE_TOOL_SCHEMA = {
    ...
    "description": (
        ...
        "견적 결과를 사용자에게 보여줄 때는 응답의 cta 필드 내용을 포함해서 다이사(https://da24.co.kr) 접수를 안내하세요. "
